...
public class Task implements Serializable {
	...
	public TaskCategory getCategory() {
		return TimeTracker.getInstance().getCategory(taskCategory);
	}
	...
	public void setCategory(TaskCategory category) {
		...
		Vector<TaskCategory> categories = TimeTracker.getInstance().getCategories();
		if (!categories.contains(category)) {
			categories.add(category);
			TimeTracker.getInstance().updateCategories();
		}
	}
	...
	public void sync(Task originalData) {
		Vector<Account>	accounts = TimeTracker.getInstance().getAccounts();
