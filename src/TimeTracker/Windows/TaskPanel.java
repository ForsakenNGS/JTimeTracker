...
import TimeTracker.Tasks.TableTimeModel;
...
public class TaskPanel extends JPanel implements ChangeListener, DocumentListener, ItemListener {
	...
	public TaskPanel() {
		...
		AbstractFormatter		dateFormatter = new DatePickerFormatter();
	...
	protected void timeTrackStart() {
		...
		TimeTracker.getInstance().saveTasks();
	...
	public Boolean saveTask() {
		...
		Vector<Task>	taskList = TimeTracker.getInstance().getTasks();
